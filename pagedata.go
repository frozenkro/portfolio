...
var tagIcons = map[string]struct {
	...
	"Typescript/Node": {"/images/icons8-typescript-48.png", "TypeScript logo", false},
	"SQL":             {"/images/icons8-sql-48.png", "SQL logo", false},
	"NoSQL":           {"/images/icons8-elasticsearch-48.png", "ElasticSearch logo", false},
	"Nuget":           {"/images/nuget.svg", "NuGet logo", false},
	"Redis":           {"/images/icons8-redis-48.png", "Redis logo", false},
	"C#/.NET":         {"/images/icons8-csharp-48.png", "C# logo", false},
	".NET Framework":  {"/images/dotnet.svg", ".NET logo", false},
	"Terraform":       {"/images/icons8-terraform-48.png", "Terraform logo", false},
	"Linux":           {"/images/icons8-linux-48.png", "Linux logo", false},
	"Git":             {"/images/icons8-git-48.png", "Git logo", false},
	"GitHub Actions":  {"/images/github-actions.svg", "GitHub Actions logo", false},
	"Sonarcloud":      {"/images/sonarcloud.svg", "SonarCloud logo", false},
	"NewRelic":         {"/images/newrelic.svg", "NewRelic logo", false},
	"InfluxDB":        {"/images/influxdb.svg", "InfluxDB logo", false},
	"Mosquitto":       {"/images/mosquitto.svg", "Mosquitto logo", false},
	"AWS":             {"/images/icons8-aws-48.png", "AWS logo", false},
	"Angular":         {"/images/angular.svg", "Angular logo", false},
	"React":           {"/images/react.svg", "React logo", false},
	"Webpack":         {"/images/icons8-webpack-48.png", "Webpack logo", false},
	"AngularJS":       {"/images/icons8-angularjs-48.png", "AngularJS logo", false},
	"Gulp":            {"/images/gulp.svg", "Gulp logo", false},
	"Neovim":          {"/images/neovim.svg", "Neovim logo", false},
	"tmux":            {"/images/tmux.svg", "tmux logo", false},
	"Opencode":        {"/images/opencode.svg", "OpenCode logo", false},
}
